\begin{tikzpicture}[
 ...
 \node[lang, coqp, hyperlink node=\coqurl{NRAEnv.Lang}{NRAEnv}{nraenv},
       right=of camp]
      (nraenv) {\NRAEnv};
 \node[lang, coqp, hyperlink node=\coqurl{NRAEnv.Core}{cNRAEnv}{nraenv_core},
       below=2em of nraenv]
      (cnraenv) {c\NRAEnv};
 ...
 \node[lang, coqp, hyperlink node=\coqurl{NNRC.Lang}{NNRC}{nnrc},
       right=of nraenv]
      (nnrc) {NNRC};
 \node[lang, coqp, hyperlink node=\coqurl{NNRC.Core}{cNNRC}{nnrc},
       below=2em of nnrc]
      (cnnrc) {cNNRC};
 ...
 \node[lang, target, hyperlink node=\coqurl{Cloudant.Lang}{Cloudant}{cloudant},
       right=of cldmr]
      (cloudant) {Cloudant};
 \node[lang, target, hyperlink node=\coqurl{JavaScript.Lang}{Java}{java},
       above=0.25em of cloudant]
      (java) {Java};
 \node[lang, target, hyperlink node=\coqurl{JavaScript.Lang}{JavaScript}{js},
       above=0.25em of java]
      (js) {JS};
 \node[lang, target,
       hyperlink node=\coqurl{SparkRDD.Lang}{SparkRDD}{spark_rdd},
       below=0.25em of cloudant]
      (sparkmr) {Spark\\(map-reduce)};
 \node[lang, target,
       below=0.25em of sparkmr]
      (spark) {Spark\\(datasets)};

% DNNRC
 \node[lang, coqc, hyperlink node=\coqurl{}{TDNNRCDataset}{dnnrc_typed},
       below=of cldmr, left=of spark]
      (tdnnrc) {tDNNRC};
 \node[lang, coqc, hyperlink node=\coqurl{DNNRC.Lang}{DNNRC}{dnnrc}]
      at (nnrcmr |- tdnnrc)
      (dnnrc) {DNNRC};


 % Sources
 \path[trans, tcoqc] (semrule.east) -- (rule.west);
 ...
 % *NRA*
 \tikzoptim[ccoqp]{nraenv}{\coqurl{NRAEnv.Optim}{NRAEnvOptimizer}{run_nraenv_optims}}
 ...
 \path[trans, tcoqp] ([xshift=0.25em] nraenv.south) -- ([xshift=0.25em] cnraenv.north)
   \transref{3}{\coqurl{NRAEnv.Lang}{NRAEnv}{nraenv_core_of_nraenv}};
 \path[trans, tcoqp] ([xshift=-0.25em] cnraenv.north) -- ([xshift=-0.25em] nraenv.south)
   \transref{3}{\coqurl{NRAEnv.Lang}{NRAEnv}{nraenv_of_nraenv_core}};
 ...
 % *NNRC
 \tikzoptim[ccoqp]{nnrc}{\coqurl{NNRC.Optim}{NNRCOptimizer}{run_nnrc_optims}}
 ...
 \path[trans, tcoqc] ([yshift=-0.25em] nnrcmr.west) -- ([yshift=-0.25em] nnrc.east)
   \transref{3}{\coqurl{Translation}{NNRCMRtoNNRC}{nnrc_of_nnrcmr}};
 \path[trans, tcoqc] (nnrc) -- (dnnrc)
   \transref{6}{\coqurl{Translation}{NNRCtoDNNRC}{nnrc_to_dnnrc_top}};
 \path[trans, tcoqc] (nnrc)
   .. controls ([yshift=3em] nnrcmr.north) ..
   (js.west)
 ...
 \path[trans, tcoqp] ([xshift=0.25em] nnrc.south) -- ([xshift=0.25em] cnnrc.north)
   \transref{3}{\coqurl{NNRC.Lang}{NNRC}{nnrc_to_nnrc_core}};
 \path[trans, tcoqp] ([xshift=-0.25em] cnnrc.north) -- ([xshift=-0.25em] nnrc.south)
   \transref{3}{\coqurl{NNRC.Core}{cNNRC}{nnrc_core_to_nnrc}};

 \path[trans, tcoqp] (cnnrc.south)
   .. controls ([yshift=-7em] nra.south) and +(0, -1.5) ..
   (camp.south)
   \transref{30}{\coqurl{Translation}{cNNRCtoCAMP}{nnrcToCamp_let}};


 % NNRCMR
 \tikzoptim[ccoqc]{nnrcmr}{\coqurl{NNRCMR.Optim}{NNRCMROptimizer}{run_nnrcmr_optims}}
 \path[trans, tcoqc] (nnrcmr) -- (cldmr)
   \transref{3}{\coqurl{Translation}{NNRCMRtoCldMR}{NNRCMRtoNNRCMRCloudantTop}};
 ...
 \path[trans, tcoqc] (cldmr) -- (cloudant)
   \transref{3}{\coqurl{Translation}{CldMRtoCloudant}{mapReducePairstoCloudant}};

 % DNNRC
 \path[trans, tcoqc] (dnnrc) -- (tdnnrc)
   \transref{3}{\coqurl{Translation}{DNNRCtotDNNRC}{dnnrc_to_dnnrc_typed_top}};

 \tikzoptim[ccoqc]{tdnnrc}{\coqurl{DNNRC.Optim}{tDNNRCOptimizer}{dnnrcToDatasetRewrite}}
 \path[trans, tcoqc] (tdnnrc) -- (spark)
   \transref{3}{\coqurl{Translation}{tDNNRCtoSparkDF}{dnnrcToSpark2Top}};
